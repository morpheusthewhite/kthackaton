...
function click(d) {
    ...
    myTable.rows[0].cells[1].innerHTML = d.name;
    if (d.director) {
        var myTable = document.getElementById('tb1');
        myTable.rows[1].cells[1].innerHTML = d.director;
    }
    if (d.runtime) {
        var myTable = document.getElementById('tb1');
        myTable.rows[2].cells[1].innerHTML = d.runtime;
    }
    if (d.release_date) {
        var myTable = document.getElementById('tb1');
        myTable.rows[3].cells[1].innerHTML = d.release_date;
    }
    if (d.genres) {
        var myTable = document.getElementById('tb1');
